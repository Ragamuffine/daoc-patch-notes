...
patch_1_121 =
    [h2 [] [text "スカウト 1.121"],
     text "スカウトはフルリスペックされる。",
     text "スカウトはレルムアビリティーをリスペックされる。",
     ...
     ulist ["Level 16 - Point Blank Shot 1 - 74 damage - 2s cast 妨害不可 - 90s 再使用 - 500 range - 自分を対象にした bladeturn 30 秒間, 10秒ごと、同時に 14% haste buff",
            "Level 26 - Point Blank Shot 2 - 134 damage - 2s cast 妨害不可 - 90s 再使用 - 500 range - 自分を対象にした bladeturn 30 秒間, 8秒ごと、同時に 21% haste buff",
            "Level 36 - Point Blank Shot 3 - 195 damage - 2s cast 妨害不可 - 90s 再使用 - 500 range - 自分を対象にした bladeturn 30 秒間, 6秒ごと、同時に 28% haste buff"],
