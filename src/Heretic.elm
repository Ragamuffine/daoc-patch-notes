...
patch_1_121 =
    [h2 [] [text "ヘレティック 1.121"],
     ...
     text "Reanimate Corpse (monster rez) は次のように変更される。100% hitpoints/power/endurance ではなくて 50% になる。resurrection sickness が除去されるのはそのままである。heal/buff することが可能になる。20 秒間継続の 75% damage reduction を得る。AoE DoT を失う。disease 状態になる。cure disease は可能だが damage reduction を失う。",
     br [] [],
     text "新しい single target matter DD が追加される。",
     ulist ["Level 2 - Dark Ashes - 2.6s cast - 1500 range - 4 power - 13 matter damage",
            "Level 17 - Dark Obsidian - 2.6s cast - 1500 range - 9 power - 37 matter damage",
            "Level 24 - Dark Slag - 2.6s cast - 1500 range - 14 power - 64 matter damage",
            "Level 35 - Dark Basalt - 2.6s cast - 1500 range - 28 power - 108 matter damage",
            "Level 45 - Dark Magma - 2.6s cast - 1500 range - 44 power - 179 matter damage"],
