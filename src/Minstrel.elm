...
patch_1_121 =
    ...
    text "Group Pulse melee ablative chant は自分には効果がなくなる。",
    br [] [],
    text "Single target 100% melee ablative が追加. 2.8 sec cast, 60 再使用, 30 sec 継続.",
    ulist ["Barrier of Sound, Level 30, absorbs 150 melee damage.",
           "Shield of Melody, Level 40, absorbs 225 melee damage.",
           "Wall of Song, level 50, absorbs 300 melee damage."],
