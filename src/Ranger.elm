...
patch_1_121 =
    [h2 [] [text "レンジャー 1.121"],
     text "レンジャーはフルリスペックされる。",
     text "レンジャーはレルムアビリティーをリスペックされる。",
     ...
     ulist ["Level 16 - Point Blank Shot 1 - 74 damage - 2s cast 妨害不可 - 90s 再使用 - 500 range - 自分を対象にした bladeturn 30 秒間, 10秒ごと、同時に 22% haste buff",
            "Level 26 - Point Blank Shot 2 - 134 damage - 2s cast 妨害不可 - 90s 再使用 - 500 range - 自分を対象にした bladeturn 30 秒間, 8秒ごと、同時に 30% haste buff",
            "Level 36 - Point Blank Shot 3 - 195 damage - 2s cast 妨害不可 - 90s 再使用 - 500 range - 自分を対象にした bladeturn 30 秒間, 6秒ごと、同時に 39% haste buff"],
     ...
     ulist ["Level 15 - Thunderstorm - Detaunt anytime - Defensive bonus とダメージを他の detaunt スタイル並に減少",
            ...
            "Level 33 - Twin Star I - Tornado - ダメージ増加",
            "Level 34 - Meteor Shower - Anytime - ダメージ減少",
            "Level 39 - Solar Flare - Frozen Comet - -34% attack speed debuff effect, ダメージ増加",
            "Level 50 - Supernova - Hurricane - ダメージかなり増加"],
     sechib "Blades (スペック)",
