...
patch_1_121 =
    [h2 [] [text "リーバー 1.121"],
     ...
     text "PBAoE damage pulse の半径は 400 に拡大される。再使用タイマーはなくなりいつでも詠唱できる。",
     br [] [],
     text "Pulsing PBAoE Melee DPS debuff は 25 秒間継続する。再使用 120 秒。",
     br [] [],
     text "レベル 8 の Crippling Curse spell はレベル 3 になる。",
     br [] [],
     ...
     ulist ["Level 5 - Aura of Foreboding - Instant Cast - 120s 再使用 - 350 半径 - 25秒間継続 - 2 power - 6% ABS debuff",
            "Level 14 - Aura of Destiny - Instant Cast - 120s 再使用 - 350 半径 - 25秒間継続 - 6 power - 9% ABS debuff",
            "Level 25 - Aura of Fate - Instant Cast - 120s 再使用 - 350 半径 - 25秒間継続 - 10 power - 11% ABS debuff",
            "Level 35 - Aura of Destiny - Instant Cast - 120s 再使用 - 350 半径 - 25秒間継続 - 14 power - 13%-15% ABS debuff",
            "Level 47 - Aura of the Inevitable - Instant Cast - 120s 再使用 - 350 半径 - 25秒間継続 - 20 power - Reduces the target's ABS by 15%-20% ABS debuff"],
