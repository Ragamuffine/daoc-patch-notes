...
patch_1_121 =
    [h2 [] [text "インフィルトレーター 1.121"],
     ...
     ulist ["Level 21 - Penumbra - Rear - 26% attack speed debuff, スタイルダメージ増加",
            "Level 34 - Dark Tendrils - Anytime - ダメージ減少",
            "Level 39 - Shadow's Rain - Flank - ダメージやや増加",
            "Level 50 - Dual Shadows - Front - ダメージやや増加"],
     secalb "Slash (スペック)",
     ulist ["Level 34 - Amethyst Slash - Anytime - ダメージ減少",
            "Level 39 - Backslash - Rear - スネア除去, ダメージやや増加"],
     secalb "Thrust (スペック)",
